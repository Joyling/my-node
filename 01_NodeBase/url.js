...
http.createServer(function (req, res) {
  ...
  // 4. 获取服务器请求
  /**
   * 访问地址是：http://localhost:3000/?userName=myjs&userAge=23
   * 如果你执行 console.log(req.url)，它将执行两次，分别返回下面的信息：
   * /  ?userName=myjs&userAge=23
   * /  /favicon.ico
  ...
  if(req.url != "/favicon.ico") {
     ...
     *   hostname: null,
     *   hash: null,
     *   search: '?userName=myjs&userAge=23',
     *   query: { userName: 'myjs', userAge: '23' },
     *   pathname: '/',
     *   path: '/?userName=myjs&userAge=23',
     *   href: '/?userName=myjs&userAge=23' }
     */

    console.log(result.query.userName); // myjs
